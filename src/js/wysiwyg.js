...
var commands = {
    ...
    table: makeCommand("insertHtml", "<table><tr><td>qwe</td><td>ewq</td></tr></table>"),
...
function makeCommand(command, param) {
    return userParam => document.execCommand(command, false, param || userParam);
}
